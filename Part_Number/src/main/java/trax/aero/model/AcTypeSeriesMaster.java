...
public class AcTypeSeriesMaster implements Serializable {
	...
	@Column(name="MODEL_INDENT_CODE")
	private String modelIndentCode;
	...
	//bi-directional many-to-one association to PnEffectivityHeader
	@OneToMany(mappedBy="acTypeSeriesMaster")
	private List<PnEffectivityHeader> pnEffectivityHeaders;
	...
	public String getModelIndentCode() {
		return this.modelIndentCode;
	}

	public void setModelIndentCode(String modelIndentCode) {
		this.modelIndentCode = modelIndentCode;
	}
	...
	public List<PnEffectivityHeader> getPnEffectivityHeaders() {
		return this.pnEffectivityHeaders;
	}

	public void setPnEffectivityHeaders(List<PnEffectivityHeader> pnEffectivityHeaders) {
		this.pnEffectivityHeaders = pnEffectivityHeaders;
	}

	public PnEffectivityHeader addPnEffectivityHeader(PnEffectivityHeader pnEffectivityHeader) {
		getPnEffectivityHeaders().add(pnEffectivityHeader);
		pnEffectivityHeader.setAcTypeSeriesMaster(this);

		return pnEffectivityHeader;
	}

	public PnEffectivityHeader removePnEffectivityHeader(PnEffectivityHeader pnEffectivityHeader) {
		getPnEffectivityHeaders().remove(pnEffectivityHeader);
		pnEffectivityHeader.setAcTypeSeriesMaster(null);
