...
public class AcMaster implements Serializable {
	...
	//bi-directional many-to-one association to PnEffectivityDistribution
	@OneToMany(mappedBy="acMaster")
	private List<PnEffectivityDistribution> pnEffectivityDistributions;
	...
	public List<PnEffectivityDistribution> getPnEffectivityDistributions() {
		return this.pnEffectivityDistributions;
	}

	public void setPnEffectivityDistributions(List<PnEffectivityDistribution> pnEffectivityDistributions) {
		this.pnEffectivityDistributions = pnEffectivityDistributions;
	}

	public PnEffectivityDistribution addPnEffectivityDistribution(PnEffectivityDistribution pnEffectivityDistribution) {
		getPnEffectivityDistributions().add(pnEffectivityDistribution);
		pnEffectivityDistribution.setAcMaster(this);

		return pnEffectivityDistribution;
	}

	public PnEffectivityDistribution removePnEffectivityDistribution(PnEffectivityDistribution pnEffectivityDistribution) {
		getPnEffectivityDistributions().remove(pnEffectivityDistribution);
		pnEffectivityDistribution.setAcMaster(null);
