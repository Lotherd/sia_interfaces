...
public class LocationSiteCapacity 
{
	...
	public void setWorkDate(DateTime dtPlusOne) {
		this.workDate = dtPlusOne;
	}
	...
	public void setStartWorkDate(DateTime dateTime) {
		this.startWorkDate = dateTime;
	}
