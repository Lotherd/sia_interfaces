...
public class WoTaskCard implements Serializable {
	...
	@Column(name="INTERFACE_SAP_DATE")
	private Date interfaceSapDate;

	@Column(name="INTERFACE_SAP_TRANSFER_DATE")
	private Date interfaceSapTransferDate;

	@Column(name="INTERFACE_SAP_TRANSFER_FALG")
	private String interfaceSapTransferFalg;
	...
	@Column(name="MAN_HOUR_HOURS")
	private BigDecimal manHourHours;

	@Column(name="MAN_HOUR_MINUTES")
	private BigDecimal manHourMinutes;
	...
	public Date getInterfaceSapDate() {
		return this.interfaceSapDate;
	}

	public void setInterfaceSapDate(Date interfaceSapDate) {
		this.interfaceSapDate = interfaceSapDate;
	}
	...
	public String getInterfaceSapTransferFalg() {
		return this.interfaceSapTransferFalg;
	}

	public void setInterfaceSapTransferFalg(String interfaceSapTransferFalg) {
		this.interfaceSapTransferFalg = interfaceSapTransferFalg;
	}
	...
	public BigDecimal getManHourHours() {
		return this.manHourHours;
	}

	public void setManHourHours(BigDecimal manHourHours) {
		this.manHourHours = manHourHours;
	}

	public BigDecimal getManHourMinutes() {
		return this.manHourMinutes;
	}

	public void setManHourMinutes(BigDecimal manHourMinutes) {
		this.manHourMinutes = manHourMinutes;
	}
