...
/**
 * The persistent class for the TASK_CARD_REV database table.
 * 
 */
@Entity
@Table(name="TASK_CARD_REV")
@NamedQuery(name="TaskCardRev.findAll", query="SELECT t FROM TaskCardRev t")
public class TaskCardRev implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TaskCardRevPK id;
	...
	@Column(name="NEW_TASK_CARD")
	private String newTaskCard;
	...
	@Column(name="PROC_REVISED_DATE")
	private Date procRevisedDate;
	...
	//bi-directional many-to-one association to TaskCardControlRev
	@OneToMany(mappedBy="taskCardRev")
	private List<TaskCardControlRev> taskCardControlRevs;

	//bi-directional many-to-one association to TaskCardEffectivityHeadRv
	@OneToMany(mappedBy="taskCardRev")
	private List<TaskCardEffectivityHeadRv> taskCardEffectivityHeadRvs;

	//bi-directional many-to-one association to TaskCardEffectivityRev
	@OneToMany(mappedBy="taskCardRev")
	private List<TaskCardEffectivityRev> taskCardEffectivityRevs;

	//bi-directional many-to-one association to TaskCardEffectivityRevHd
	@OneToMany(mappedBy="taskCardRev")
	private List<TaskCardEffectivityRevHd> taskCardEffectivityRevHds;

	//bi-directional many-to-one association to TaskCardItemRev
	@OneToMany(mappedBy="taskCardRev")
	private List<TaskCardItemRev> taskCardItemRevs;

	//bi-directional many-to-one association to TaskCardPnRev
	@OneToMany(mappedBy="taskCardRev")
	private List<TaskCardPnRev> taskCardPnRevs;

	public TaskCardRev() {
	}

	public TaskCardRevPK getId() {
		return this.id;
	}

	public void setId(TaskCardRevPK id) {
		this.id = id;
	}
	...
	public String getNewTaskCard() {
		return this.newTaskCard;
	}

	public void setNewTaskCard(String newTaskCard) {
		this.newTaskCard = newTaskCard;
	}
	...
	public Date getProcRevisedDate() {
		return this.procRevisedDate;
	}

	public void setProcRevisedDate(Date procRevisedDate) {
		this.procRevisedDate = procRevisedDate;
	}
	...
	public List<TaskCardControlRev> getTaskCardControlRevs() {
		return this.taskCardControlRevs;
	}

	public void setTaskCardControlRevs(List<TaskCardControlRev> taskCardControlRevs) {
		this.taskCardControlRevs = taskCardControlRevs;
	}

	public TaskCardControlRev addTaskCardControlRev(TaskCardControlRev taskCardControlRev) {
		getTaskCardControlRevs().add(taskCardControlRev);
		taskCardControlRev.setTaskCardRev(this);

		return taskCardControlRev;
	}

	public TaskCardControlRev removeTaskCardControlRev(TaskCardControlRev taskCardControlRev) {
		getTaskCardControlRevs().remove(taskCardControlRev);
		taskCardControlRev.setTaskCardRev(null);

		return taskCardControlRev;
	}

	public List<TaskCardEffectivityHeadRv> getTaskCardEffectivityHeadRvs() {
		return this.taskCardEffectivityHeadRvs;
	}

	public void setTaskCardEffectivityHeadRvs(List<TaskCardEffectivityHeadRv> taskCardEffectivityHeadRvs) {
		this.taskCardEffectivityHeadRvs = taskCardEffectivityHeadRvs;
	}

	public TaskCardEffectivityHeadRv addTaskCardEffectivityHeadRv(TaskCardEffectivityHeadRv taskCardEffectivityHeadRv) {
		getTaskCardEffectivityHeadRvs().add(taskCardEffectivityHeadRv);
		taskCardEffectivityHeadRv.setTaskCardRev(this);

		return taskCardEffectivityHeadRv;
	}

	public TaskCardEffectivityHeadRv removeTaskCardEffectivityHeadRv(TaskCardEffectivityHeadRv taskCardEffectivityHeadRv) {
		getTaskCardEffectivityHeadRvs().remove(taskCardEffectivityHeadRv);
		taskCardEffectivityHeadRv.setTaskCardRev(null);

		return taskCardEffectivityHeadRv;
	}

	public List<TaskCardEffectivityRev> getTaskCardEffectivityRevs() {
		return this.taskCardEffectivityRevs;
	}

	public void setTaskCardEffectivityRevs(List<TaskCardEffectivityRev> taskCardEffectivityRevs) {
		this.taskCardEffectivityRevs = taskCardEffectivityRevs;
	}

	public TaskCardEffectivityRev addTaskCardEffectivityRev(TaskCardEffectivityRev taskCardEffectivityRev) {
		getTaskCardEffectivityRevs().add(taskCardEffectivityRev);
		taskCardEffectivityRev.setTaskCardRev(this);

		return taskCardEffectivityRev;
	}

	public TaskCardEffectivityRev removeTaskCardEffectivityRev(TaskCardEffectivityRev taskCardEffectivityRev) {
		getTaskCardEffectivityRevs().remove(taskCardEffectivityRev);
		taskCardEffectivityRev.setTaskCardRev(null);

		return taskCardEffectivityRev;
	}

	public List<TaskCardEffectivityRevHd> getTaskCardEffectivityRevHds() {
		return this.taskCardEffectivityRevHds;
	}

	public void setTaskCardEffectivityRevHds(List<TaskCardEffectivityRevHd> taskCardEffectivityRevHds) {
		this.taskCardEffectivityRevHds = taskCardEffectivityRevHds;
	}

	public TaskCardEffectivityRevHd addTaskCardEffectivityRevHd(TaskCardEffectivityRevHd taskCardEffectivityRevHd) {
		getTaskCardEffectivityRevHds().add(taskCardEffectivityRevHd);
		taskCardEffectivityRevHd.setTaskCardRev(this);

		return taskCardEffectivityRevHd;
	}

	public TaskCardEffectivityRevHd removeTaskCardEffectivityRevHd(TaskCardEffectivityRevHd taskCardEffectivityRevHd) {
		getTaskCardEffectivityRevHds().remove(taskCardEffectivityRevHd);
		taskCardEffectivityRevHd.setTaskCardRev(null);

		return taskCardEffectivityRevHd;
	}

	public List<TaskCardItemRev> getTaskCardItemRevs() {
		return this.taskCardItemRevs;
	}

	public void setTaskCardItemRevs(List<TaskCardItemRev> taskCardItemRevs) {
		this.taskCardItemRevs = taskCardItemRevs;
	}

	public TaskCardItemRev addTaskCardItemRev(TaskCardItemRev taskCardItemRev) {
		getTaskCardItemRevs().add(taskCardItemRev);
		taskCardItemRev.setTaskCardRev(this);

		return taskCardItemRev;
	}

	public TaskCardItemRev removeTaskCardItemRev(TaskCardItemRev taskCardItemRev) {
		getTaskCardItemRevs().remove(taskCardItemRev);
		taskCardItemRev.setTaskCardRev(null);

		return taskCardItemRev;
	}

	public List<TaskCardPnRev> getTaskCardPnRevs() {
		return this.taskCardPnRevs;
	}

	public void setTaskCardPnRevs(List<TaskCardPnRev> taskCardPnRevs) {
		this.taskCardPnRevs = taskCardPnRevs;
	}

	public TaskCardPnRev addTaskCardPnRev(TaskCardPnRev taskCardPnRev) {
		getTaskCardPnRevs().add(taskCardPnRev);
		taskCardPnRev.setTaskCardRev(this);

		return taskCardPnRev;
	}

	public TaskCardPnRev removeTaskCardPnRev(TaskCardPnRev taskCardPnRev) {
		getTaskCardPnRevs().remove(taskCardPnRev);
		taskCardPnRev.setTaskCardRev(null);
