...
/**
 * The primary key class for the TASK_CARD_EFFECTIVITY_REV_HD database table.
 * 
 */
@Embeddable
public class TaskCardEffectivityRevHdPK implements Serializable {
	...
	public TaskCardEffectivityRevHdPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TaskCardEffectivityRevHdPK)) {
			return false;
		}
		TaskCardEffectivityRevHdPK castOther = (TaskCardEffectivityRevHdPK)other;
		return 
