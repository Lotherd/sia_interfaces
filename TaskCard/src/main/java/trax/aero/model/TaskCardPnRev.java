...
/**
 * The persistent class for the TASK_CARD_PN_REV database table.
 * 
 */
@Entity
@Table(name="TASK_CARD_PN_REV")
@NamedQuery(name="TaskCardPnRev.findAll", query="SELECT t FROM TaskCardPnRev t")
public class TaskCardPnRev implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TaskCardPnRevPK id;
	...
	public TaskCardPnRev() {
	}

	public TaskCardPnRevPK getId() {
		return this.id;
	}

	public void setId(TaskCardPnRevPK id) {
		this.id = id;
	}
