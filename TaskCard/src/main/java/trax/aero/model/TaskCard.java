...
public class TaskCard implements Serializable {
	...
	//bi-directional many-to-one association to TaskCardControl
	@OneToMany(mappedBy="taskCardBean")
	private List<TaskCardControl> taskCardControls;

	//bi-directional many-to-one association to TaskCardEffectivity
	@OneToMany(mappedBy="taskCardBean")
	private List<TaskCardEffectivity> taskCardEffectivities;
	...
	public List<TaskCardControl> getTaskCardControls() {
		return this.taskCardControls;
	}

	public void setTaskCardControls(List<TaskCardControl> taskCardControls) {
		this.taskCardControls = taskCardControls;
	}

	public TaskCardControl addTaskCardControl(TaskCardControl taskCardControl) {
		getTaskCardControls().add(taskCardControl);
		taskCardControl.setTaskCardBean(this);

		return taskCardControl;
	}

	public TaskCardControl removeTaskCardControl(TaskCardControl taskCardControl) {
		getTaskCardControls().remove(taskCardControl);
		taskCardControl.setTaskCardBean(null);

		return taskCardControl;
	}

	public List<TaskCardEffectivity> getTaskCardEffectivities() {
		return this.taskCardEffectivities;
	}

	public void setTaskCardEffectivities(List<TaskCardEffectivity> taskCardEffectivities) {
		this.taskCardEffectivities = taskCardEffectivities;
	}

	public TaskCardEffectivity addTaskCardEffectivity(TaskCardEffectivity taskCardEffectivity) {
		getTaskCardEffectivities().add(taskCardEffectivity);
		taskCardEffectivity.setTaskCardBean(this);

		return taskCardEffectivity;
	}

	public TaskCardEffectivity removeTaskCardEffectivity(TaskCardEffectivity taskCardEffectivity) {
		getTaskCardEffectivities().remove(taskCardEffectivity);
		taskCardEffectivity.setTaskCardBean(null);
