...
/**
 * The primary key class for the TASK_CARD_CONTROL database table.
 * 
 */
@Embeddable
public class TaskCardControlPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TaskCardControlPK)) {
			return false;
		}
		TaskCardControlPK castOther = (TaskCardControlPK)other;
		return 
