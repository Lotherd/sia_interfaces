...
/**
 * The primary key class for the TASK_CARD_EFFECTIVITY_HEAD_RV database table.
 * 
 */
@Embeddable
public class TaskCardEffectivityHeadRvPK implements Serializable {
	...
	public TaskCardEffectivityHeadRvPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TaskCardEffectivityHeadRvPK)) {
			return false;
		}
		TaskCardEffectivityHeadRvPK castOther = (TaskCardEffectivityHeadRvPK)other;
		return 
