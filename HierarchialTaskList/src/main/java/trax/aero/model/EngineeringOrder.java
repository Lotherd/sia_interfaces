...
/**
 * The persistent class for the ENGINEERING_ORDER database table.
 * 
 */
@Entity
@Table(name="ENGINEERING_ORDER")
@NamedQuery(name="EngineeringOrder.findAll", query="SELECT e FROM EngineeringOrder e")
public class EngineeringOrder implements Serializable {
	...
	//bi-directional many-to-one association to EngineeringScheduleControl
	@OneToMany(mappedBy="engineeringOrder")
	private List<EngineeringScheduleControl> engineeringScheduleControls;

	//bi-directional many-to-one association to EngineeringTaskCardControl
	@OneToMany(mappedBy="engineeringOrder")
	private List<EngineeringTaskCardControl> engineeringTaskCardControls;
	...
	public List<EngineeringScheduleControl> getEngineeringScheduleControls() {
		return this.engineeringScheduleControls;
	}

	public void setEngineeringScheduleControls(List<EngineeringScheduleControl> engineeringScheduleControls) {
		this.engineeringScheduleControls = engineeringScheduleControls;
	}

	public EngineeringScheduleControl addEngineeringScheduleControl(EngineeringScheduleControl engineeringScheduleControl) {
		getEngineeringScheduleControls().add(engineeringScheduleControl);
		engineeringScheduleControl.setEngineeringOrder(this);

		return engineeringScheduleControl;
	}

	public EngineeringScheduleControl removeEngineeringScheduleControl(EngineeringScheduleControl engineeringScheduleControl) {
		getEngineeringScheduleControls().remove(engineeringScheduleControl);
		engineeringScheduleControl.setEngineeringOrder(null);

		return engineeringScheduleControl;
	}

	public List<EngineeringTaskCardControl> getEngineeringTaskCardControls() {
		return this.engineeringTaskCardControls;
	}

	public void setEngineeringTaskCardControls(List<EngineeringTaskCardControl> engineeringTaskCardControls) {
		this.engineeringTaskCardControls = engineeringTaskCardControls;
	}

	public EngineeringTaskCardControl addEngineeringTaskCardControl(EngineeringTaskCardControl engineeringTaskCardControl) {
		getEngineeringTaskCardControls().add(engineeringTaskCardControl);
		engineeringTaskCardControl.setEngineeringOrder(this);

		return engineeringTaskCardControl;
	}

	public EngineeringTaskCardControl removeEngineeringTaskCardControl(EngineeringTaskCardControl engineeringTaskCardControl) {
		getEngineeringTaskCardControls().remove(engineeringTaskCardControl);
		engineeringTaskCardControl.setEngineeringOrder(null);
