...
/**
 * The persistent class for the ENGINEERING_TASK_CARD_CTL_RV database table.
 * 
 */
@Entity
@Table(name="ENGINEERING_TASK_CARD_CTL_RV")
@NamedQuery(name="EngineeringTaskCardCtlRv.findAll", query="SELECT e FROM EngineeringTaskCardCtlRv e")
public class EngineeringTaskCardCtlRv implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private EngineeringTaskCardCtlRvPK id;
	...
	public EngineeringTaskCardCtlRv() {
	}

	public EngineeringTaskCardCtlRvPK getId() {
		return this.id;
	}

	public void setId(EngineeringTaskCardCtlRvPK id) {
		this.id = id;
	}
