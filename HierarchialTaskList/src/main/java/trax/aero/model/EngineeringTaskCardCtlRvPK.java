...
/**
 * The primary key class for the ENGINEERING_TASK_CARD_CTL_RV database table.
 * 
 */
@Embeddable
public class EngineeringTaskCardCtlRvPK implements Serializable {
	...
	public EngineeringTaskCardCtlRvPK() {
	}
	public String getEo() {
		return this.eo;
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof EngineeringTaskCardCtlRvPK)) {
			return false;
		}
		EngineeringTaskCardCtlRvPK castOther = (EngineeringTaskCardCtlRvPK)other;
		return 
