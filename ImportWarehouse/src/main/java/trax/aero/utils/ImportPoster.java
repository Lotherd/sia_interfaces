...
public class ImportPoster 
{
	...
	public boolean postImport(MT_TRAX_SND_I46_4077_REQ data , String URL)
	{
...

		{
			...
			try {
				...
				logger.info("POSTING Material:" + data.getMaterialNumber() + " to URL: " + url);
