...
public class WoTaskCardItem implements Serializable,Comparable<WoTaskCardItem>  {
	private static final long serialVersionUID = 1L;

	@Override
	public int compareTo(WoTaskCardItem e) {
		return  Long.compare(this.getId().getTaskCardItem(),(e.getId().getTaskCardItem()));
	}
