...
public class WoTaskCard implements Serializable {
	...
	@Column(name="IE_INDICATOR")
	private String ieIndicator;
	...
	public Date getCusReqDate() {
		return cusReqDate;
	}

	public void setCusReqDate(Date cusReqDate) {
		this.cusReqDate = cusReqDate;
	}

	public String getIeIndicator() {
		return ieIndicator;
	}

	public void setIeIndicator(String ieIndicator) {
		this.ieIndicator = ieIndicator;
	}

	public BigDecimal getCcsQty() {
		return ccsQty;
	}

	public void setCcsQty(BigDecimal ccsQty) {
		this.ccsQty = ccsQty;
	}
