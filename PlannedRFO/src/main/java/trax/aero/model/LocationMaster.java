...
public class LocationMaster implements Serializable {
	...
	//bi-directional many-to-one association to LocationSite
	...
	public LocationSite addLocationSite(LocationSite locationSite) {
		getLocationSites().add(locationSite);
		locationSite.setLocationMaster(this);

		return locationSite;
	}

	public LocationSite removeLocationSite(LocationSite locationSite) {
		getLocationSites().remove(locationSite);
		locationSite.setLocationMaster(null);
