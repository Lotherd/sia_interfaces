...
/**
 * The persistent class for the WO_AUDIT database table.
 * 
 */
@Entity
@Table(name="WO_AUDIT")
@NamedQuery(name="WoAudit.findAll", query="SELECT w FROM WoAudit w")
public class WoAudit implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private WoAuditPK id;
	...
	public WoAuditPK getId() {
		return this.id;
	}

	public void setId(WoAuditPK id) {
		this.id = id;
	}
