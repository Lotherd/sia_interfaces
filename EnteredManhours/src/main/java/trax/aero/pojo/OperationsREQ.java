...
public class OperationsREQ  implements Comparable<OperationsREQ>{
	
	@Override
	public int compareTo(OperationsREQ e) {
		return  Long.compare(new Long(this.TRAXItemNumber),(new Long(e.getTRAXItemNumber())));
	}
