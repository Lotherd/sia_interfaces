...
/**
 * The persistent class for the PN_POSITION_HEADER_AU database table.
 * 
 */
@Entity
@Table(name="PN_POSITION_HEADER_AU")
@NamedQuery(name="PnPositionHeaderAu.findAll", query="SELECT p FROM PnPositionHeaderAu p")
public class PnPositionHeaderAu implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private PnPositionHeaderAuPK id;
	...
	public PnPositionHeaderAu() {
	}

	public PnPositionHeaderAuPK getId() {
		return this.id;
	}

	public void setId(PnPositionHeaderAuPK id) {
		this.id = id;
	}
