...
/**
 * The primary key class for the PN_POSITION_HEADER database table.
 * 
 */
@Embeddable
public class PnPositionHeaderPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PnPositionHeaderPK)) {
			return false;
		}
		PnPositionHeaderPK castOther = (PnPositionHeaderPK)other;
		return 
