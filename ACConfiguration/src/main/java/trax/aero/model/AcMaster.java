...
public class AcMaster implements Serializable {
	...
	//bi-directional many-to-one association to PnPositionRestrictionEff
	@OneToMany(mappedBy="acMaster")
	private List<PnPositionRestrictionEff> pnPositionRestrictionEffs;
	...
	public List<PnPositionRestrictionEff> getPnPositionRestrictionEffs() {
		return this.pnPositionRestrictionEffs;
	}

	public void setPnPositionRestrictionEffs(List<PnPositionRestrictionEff> pnPositionRestrictionEffs) {
		this.pnPositionRestrictionEffs = pnPositionRestrictionEffs;
	}

	public PnPositionRestrictionEff addPnPositionRestrictionEff(PnPositionRestrictionEff pnPositionRestrictionEff) {
		getPnPositionRestrictionEffs().add(pnPositionRestrictionEff);
		pnPositionRestrictionEff.setAcMaster(this);

		return pnPositionRestrictionEff;
	}

	public PnPositionRestrictionEff removePnPositionRestrictionEff(PnPositionRestrictionEff pnPositionRestrictionEff) {
		getPnPositionRestrictionEffs().remove(pnPositionRestrictionEff);
		pnPositionRestrictionEff.setAcMaster(null);
